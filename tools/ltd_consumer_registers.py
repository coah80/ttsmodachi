...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarize LTD appliance consumer register captures.")
...
def main() -> int:
    ...
    print(f"consumer_register_rows={total}")
